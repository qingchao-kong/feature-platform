 ...
 *
 * @author kongqingchao
 * @create 2021-02-22 2:28 下午
 */
@Slf4j
public class RecommendOrderJob {
...
//        env.setParallelism(1);
        ...
        //1.配置数据源
        //1.1.1.
        final FlinkKafkaConsumer<Tuple3<String, String, String>> consumer = new FlinkKafkaConsumer<Tuple3<String, String, String>>("YPP-REALTIME-FEATURE-ORDER", new KafkaDeserializationTopicSchema(), properties);
//        gameConsumer.setStartFromGroupOffsets();
        ...
        log.info("starting RecommendOrderJob");
