...
//        env.setParallelism(1);
        ...
        //1.配置数据源
        //1.1.1.
        final FlinkKafkaConsumer<Tuple3<String, String, String>> consumer = new FlinkKafkaConsumer<Tuple3<String, String, String>>("YPP-REALTIME-FEATURE-USER", new KafkaDeserializationTopicSchema(), properties);
