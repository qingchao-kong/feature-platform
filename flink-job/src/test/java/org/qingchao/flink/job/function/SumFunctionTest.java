 ...
 * @author kongqingchao
 * @version 1.0
 * @date 2020/12/25 11:31 上午
 */
@Slf4j
public class SumFunctionTest {

    @Test
    public void test_kv_1min(){
        String featureNamePrefix = "testSumFunction";
        ...
        FlinkConfigDto configDto = new FlinkConfigDto();
        {
            ...
            aggConfig.put("field","ext.latitude");
            aggConfig.put("fieldType","long");
            configDto.setAggConfig(aggConfig);
            configDto.setWindows(windows);
        }
        //2.mock Function
        SumFunction sumFunction=new SumFunction(configDto);
